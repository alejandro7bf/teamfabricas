...
class Fabrica{
  ...
  late String headcount;
      ...
      Fabrica.fromFirestore(DocumentSnapshot doc){
        if(doc.data() != null){
          ...
          //this.creationDate = (doc.get('creationDate') as Timestamp).toDate();
 ...
 List<Fabrica> toFabricaList(QuerySnapshot query) {
  return query.docs.map((doc) => Fabrica.fromFirestore(doc)).toList();
}
